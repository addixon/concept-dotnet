...
/// <summary>
/// Contains Bluetooth Low Energy (BLE) UUIDs and constants for the Concept2 performance monitor.
/// </summary>
public static class BleConstants
{
    /// <summary>The base UUID for all Concept2 BLE services and characteristics.</summary>
