...
/// <summary>
/// USB HID transport for communicating with Concept2 Performance Monitors via USB.
...
/// The Concept2 PM5 uses USB Vendor ID 0x17A4 and Product ID 0x0001.
/// HID report sizes:
/// <list type="bullet">
...
public sealed class UsbTransport : ITransport
{
    ...
    /// </summary>
    /// <param name="device">
    /// An <see cref="IHidDevice"/> implementation wrapping the Concept2 PM USB HID device.
    /// </param>
